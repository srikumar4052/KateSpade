...
public class orderplacingWithMAESTRO {
	WebDriver driver;
	...
	@Test
	public void guestUsrOrderplacewithMAESTRO() throws InterruptedException, IOException {
	...
	public void Sizedrpdown() throws InterruptedException {
		...
		for (int i = 1; i <= 18; i++) {
			if (driver.findElement(By.xpath("//ul[@class='swatches size']/li[" + i + "]/a")).isEnabled()) {
				WebElement Size = driver.findElement(By.xpath("//ul[@class='swatches size']/li[" + i + "]/a"));
				Size.click();
			}
			break;
		}
	...
	public void Payment() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='creditCard_owner']")).sendKeys("CH HUDSON", Keys.TAB,
				"5555341244441115", Keys.TAB, "1020", Keys.TAB, "737");
		JavascriptExecutor js1 = (JavascriptExecutor) driver;
	...
	public void screenshot() throws IOException {
		...
		FileUtils.copyFile(file, new File(
				"D:\\Automation Scripts\\Project\\orderplacingStuartWeitzman\\screenshots\\OrderwithMAESTRO.png"));
	}
