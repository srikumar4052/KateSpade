...
public class orderplacingWithVISA {
	...
	@Test
	public void guestUsrOrderplacewithVISA() throws InterruptedException, IOException {
	...
	public void clickingtheDesiredElement() throws InterruptedException {
		...
		driver.findElement(By.xpath("(//img[@title='PENLEY LOAFER in BLACK'])[2]")).click();
		Thread.sleep(1000);
	}
	...
	public void Payment() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='creditCard_owner']")).sendKeys("CH HUDSON", Keys.TAB,
				"4646 4646 4646 4644", Keys.TAB, "1020", Keys.TAB, "737");
		JavascriptExecutor js1 = (JavascriptExecutor) driver;
	...
	public void screenshot() throws IOException {
		...
		FileUtils.copyFile(file, new File(
				"D:\\Automation Scripts\\Project\\orderplacingStuartWeitzman\\screenshots\\OrderwithVISA.png"));
	}
