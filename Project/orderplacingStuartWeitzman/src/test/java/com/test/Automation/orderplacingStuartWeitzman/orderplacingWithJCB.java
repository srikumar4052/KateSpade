...
public class orderplacingWithJCB {
	WebDriver driver;
	...
	@Test
	public void guestUsrOrderplacewithJCB() throws InterruptedException, IOException {
	...
	public void Payment() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='creditCard_owner']")).sendKeys("CH HUDSON", Keys.TAB,
				"3569990010095841", Keys.TAB, "1020", Keys.TAB, "737");
		JavascriptExecutor js1 = (JavascriptExecutor) driver;
	...
	public void screenshot() throws IOException {
		...
		FileUtils.copyFile(file,
				new File("D:\\Automation Scripts\\Project\\orderplacingStuartWeitzman\\screenshots\\OrderwithJCB.png"));
	}
