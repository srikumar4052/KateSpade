...
public class orderplacingWithAMEX {
	WebDriver driver;
	...
	@Test
	public void guestUsrOrderplacewithAMEX() throws InterruptedException, IOException {
	...
	public void clickingtheDesiredElement() throws InterruptedException {
		 ...
		 * )) .click();
		 */
		driver.findElement(By.xpath("(//a[@title='Go to Product: 5050'])[2]")).click();
		Thread.sleep(1000);
	}
	...
	public void Payment() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='creditCard_owner']")).sendKeys("CH HUDSON", Keys.TAB,
				"370000000000002", Keys.TAB, "1020", Keys.TAB, "7373");
		JavascriptExecutor js1 = (JavascriptExecutor) driver;
	...
	public void screenshot() throws IOException {
		...
		FileUtils.copyFile(file, new File(
				"D:\\Automation Scripts\\Project\\orderplacingStuartWeitzman\\screenshots\\OrderwithAMEX.png"));
	}
